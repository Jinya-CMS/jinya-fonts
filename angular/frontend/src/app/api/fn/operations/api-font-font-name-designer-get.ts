...
export function apiFontFontNameDesignerGet(http: HttpClient, rootUrl: string, params: ApiFontFontNameDesignerGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Designer>> {
